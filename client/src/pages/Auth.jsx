      ...
      >
        <div style={{ display: 'flex', marginBottom: '2.5rem', position: 'relative' }}>
          <button 
            ...
            style={{ flex: 1, padding: '0.5rem', fontSize: '1.2rem', color: isLogin ? 'var(--text-chalk)' : 'var(--text-dim)' }}
          >
            Login
          </button>
          <button 
          ...
          <motion.div 
            ...
            style={{ 
              ...
              background: 'var(--accent-yellow)', boxShadow: '0 0 10px var(--accent-yellow)'
            }}
          />
        </div>
          ...
          >
              ...
              {!isLogin && password.length > 0 && (
                <div style={{ marginTop: '1rem' }}>
                  ...
                  <div style={{ height: '4px', background: 'rgba(255,255,255,0.1)', borderRadius: '2px', overflow: 'hidden' }}>
                    <motion.div 
                      animate={{ 
                        width: `${(passwordRules.filter(r => r.met).length / 5) * 100}%`,
            ...
            {error && (
              <motion.p 
                ...
                animate={{ opacity: 1, x: 0 }}
                style={{ color: 'var(--accent-red)', fontSize: '0.85rem', textAlign: 'center' }}
              >
                {error}
              </motion.p>
            )}
            ...
            <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '1rem', fontSize: '1.1rem', marginTop: '1rem' }}>
              {isLogin ? 'Enter the Classroom' : 'Start My Journey'}
            </button>
            ...
            {isLogin && (
              <button type="button" style={{ color: 'var(--text-dim)', fontSize: '0.85rem', marginTop: '0.5rem', textDecoration: 'underline' }}>
                Forgot password?
              </button>
            )}
          </motion.form>
